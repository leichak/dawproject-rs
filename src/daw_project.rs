...
use {
    crate::{meta_data::MetaData, project::Project},
...
impl DawProject {
    ...
    pub fn export_schema() -> Result<String, Box<dyn Error>> {
        /*
    ...
    pub fn to_xml(object: ObjectType) -> Result<String, Box<dyn Error>> {
        /*
    ...
    pub fn project_from_xml(xml_string: String) -> Result<Project, Box<dyn Error>> {
    ...
    pub fn metadata_from_xml(xml_string: String) -> Result<MetaData, Box<dyn Error>> {
        match from_str(&xml_string) {
            Ok(project) => Ok(project),
            Err(err) => Err(err.into()),
        }
    ...
    pub fn create_context() -> Result<(), Box<dyn Error>> {
        /*
    ...
    pub fn save_xml(project: Project, path: &Path) -> Result<(), Box<dyn Error>> {
    ...
    pub fn validate(_project: Project) -> Result<(), Box<dyn Error>> {
        /*
    ...
    pub fn load_project(fname: &Path) -> Result<Project, Box<dyn Error>> {
    ...
    pub fn load_metadata(fname: &Path) -> Result<MetaData, Box<dyn Error>> {
        let zip_file = std::fs::File::open(fname).unwrap();
        let mut archive = zip::ZipArchive::new(zip_file).unwrap();
    ...
    pub fn stream_embedded(_file: &Path, _embedded_path: String) -> Result<(), Box<dyn Error>> {
        todo!("Implement");
    }
}
